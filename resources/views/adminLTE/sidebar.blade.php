...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li class="header">MODULES DISPONIBLES</li>
            <li class="treeview">
                <a href="#">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ url('evenement') }}"><i class="fa fa-circle-o"></i> Liste des événements</a></li>
                    <li><a href="{{ url('evenement/create') }}"><i class="fa fa-circle-o"></i> Création de événements</a></li>
                </ul>
            </li>
            <!--<li>
